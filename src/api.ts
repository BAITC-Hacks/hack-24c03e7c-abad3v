...
const useMock = import.meta.env.VITE_API_MODE !== 'api'
...
export const api = {
  ...
  createApplication: (taskId: string, body: { idea: string; plan: string; timeline: string; prototypeUrl: string | null; clientRequestId: string }) => useMock
